            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h1 class="text-white py-100">Unikai Juice</h1>
                    </div>
                </div>
            </div>
                ...
                <div class="row ">
                    <div class="col-lg-12 text-center">
                        <div class="page-breadcumb py-2">
                            ...
                            <a href="#" class="text-white h6">Unikai Juice</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row product-desc">
                                ...
                                <div class="col-md-8 col-lg-8">
                                    <table class="table table-striped-food">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">Low Fat</th>
                                                <td>180 ml</td>
                                                <td>1 Ltr</td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Full Fat</th>
                                                <td>180 ml</td>
                                                <td>1 Ltr</td>
                                            </tr>
                                        </tbody>
