      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center">
            <div class="section-title">
              <p class="section-subtitle">Our Profile<h2 class="mb-3">KINGPACK FOOD</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-0 text-center room-grid">
              <div class="gallery-item ">
                <a href="images/food/monin-syrup.jpg" title="Monin Syrup">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-0 text-center room-grid">
              <div class="gallery-item ">
                <a href="images/food/dry-cake.jpg" title="Olymbic Dry Cake">
