...
<head>
  ...
  <meta name="description" content="Explore from our wide range of Plastic, Aluminium, Paper, Black base, Foam, Wooden etc. ">

  <title>Products - Kingpack Group | Packing with passion</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h1 class="text-white py-100">Products</h1>
          </div>
        </div>
      </div>
                ...
                <div class="col-sm-12 col-12 col-lg-4 col-md-6">
                  <figure class="ed-room position-relative mb-4 mt-0-highlight featured-room overflow-hidden rounded">
                    ...
                    <figcaption class=" ">
                      ...
                      <div class="ed-member"><a class="btn btn-outline-primary btn-sm" href="cleaning-products" role="button">Explore</a></div>
                    </figcaption>
                  </figure>
                </div>
              </div>
