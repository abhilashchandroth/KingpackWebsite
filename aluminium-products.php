...
<head>
  ...
  <meta name="description" content="Introducing wide range of large capacity colorful aluminum products like cling film, foil, containers, burger foil wrap etc.">  

  <title>Aluminium Products - Kingpack Group | Packing with passion</title>
...
<body>
  ...
  <div class="main-wrapper ">
    <section class="overly" style="background: url(images/products/aluminium-products/bg-1.jpg)no-repeat fixed center;background-size: cover;">
      <div class="container">
        <div class="row">
