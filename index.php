		...
		<div class="row justify-content-center">
			<div class="col-lg-8 text-center">
				<div class="section-title">
					...
					<p class="mb-4">Kingpack trading was established in the Kingdom of Bahrain in 2013 as a company involved in marketing and distribution of consumable disposables and gradable food packaging products.The company has been growing steadily due to its professionalism and its commitment towards its clients.
							In Kingpack, customer satisfaction is given the utmost priority and we always strive to cater to their specific needs without compromising on quality.
							In Kingpack, employees are regarded as a valuable asset and we provide them with a positive conducive work atmosphere leading to better productivity.Here , at Kingpack we work with sincerity and dedication to achieve our common goals for a better and brighter future.</p>
	...
	<div class="container">
        ...
        <div class="row">				
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="card text-center border-0 rounded-0 mb-4 mb-lg-0">
					<a href="room-details.html"><img src="img/970x647/05.jpg" alt="" class="img-fluid card-img-top rounded-0"></a>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="card text-center border-0 rounded-0 mb-4 mb-lg-0">
					<a href="room-details.html"><img src="img/970x647/06.jpg" alt="" class="img-fluid card-img-top rounded-0"></a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<article class="col-lg-4 col-md-4 col-sm-6 col-xs-12 clearfix " >
					<div class="card rounded-0 pb-2 mb-4 mb-lg-0">
						<div class="media-wrapper">
							<img src="images/blog/img.jpg" alt="amazing caves coverimage" class="img-fluid w-100">
						</div>
						
						<div class="card-body px-4 ">
							<span class='post-meta'><i class="ion-android-calendar"></i> 17 May 2019 by admin</span>
							<a href="single-post.html" class="mt-3 d-block mb-4 pb-2"><h3>Why choose Sparta Plaza Hotel to travel this summer</h3></a>
				...
				<article class="col-lg-4 col-md-4 col-sm-6 col-xs-12 clearfix " >
					<div class="card rounded-0 pb-2 mb-4 mb-lg-0">
						<div class="media-wrapper">
							<img src="images/blog/img1.jpg" alt="amazing caves coverimage" class="img-fluid w-100">
						</div>
						
						<div class="card-body px-4">
							<span class='post-meta'><i class="ion-android-calendar"></i> 10 June 2019 by admin</span>
							<a href="single-post.html" class="mt-3 d-block mb-4 pb-2"><h3>Top best rooms in the hotel to stay long with family</h3></a>
				...
				<article class="col-lg-4 col-md-4 col-sm-6 col-xs-12 clearfix " >
					<div class="card rounded-0 pb-2 mb-4 mb-lg-0">
						<div class="media-wrapper">
							<img src="images/blog/img2.jpg" alt="amazing caves coverimage" class="img-fluid w-100">
						</div>
						
						<div class="card-body px-4">
							<span class='post-meta'><i class="ion-android-calendar"></i> 5 Jan 2019 by admin</span>
							<a href="single-post.html" class="mt-3 d-block mb-4 pb-2"><h3>Best Marketing Tips for business growth rapidly</h3></a>
