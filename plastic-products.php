...
<head>
  ...
  <meta name="description" content="Explore wide range of plastic prodcuts.">

  <title>Plastic Products - Kingpack Group | Packing with passion</title>
...
<body>
  ...
  <div class="main-wrapper ">
    <section class="overly" style="background: url(images/backgrounds/plastic/bg-1.jpg)no-repeat fixed center;background-size: contain;">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h1 class="text-white py-100">Plastic Products</h1>
          </div>
        </div>
      </div>
  ...
  <script>
        $(document).ready(function () {
            addRemoveActiveClass("products", "plastic");
        });
    </script>
</body>
